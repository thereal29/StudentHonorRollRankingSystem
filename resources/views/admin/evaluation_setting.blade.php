...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="wrapper">
                    <h3>Evaluation Settings / A.Y. 2022-2023</h3>
                    </br>
                    </br>
                    <div class="card">
                        <div class="card-header">
                            <strong><i class="bx bx-data"></i>Grade 10 Students Peer Evaluation Questionnaires</strong>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <!-- <div class="col-md-8">
                            ...
                            <table class="table table-bordered table-striped ">
                                <thead id="column_name">
                                    <tr>
                                        ...
                                        <th style="font-size:14px; font-weight:bold; text-align:center;">Academic Year</th>
                                        <th style="font-size:14px; font-weight:bold; text-align:center;">Questions</th>
                                        <th style="font-size:14px; font-weight:bold; text-align:center;">Answered</th>
...
@endsection
@section('pagetitle')
    <a class="navbar-brand" href="#pablo">Evaluation</a>
@endsection