        ...
        <div class="row profile-wrapper">
            <div class="col-md-4">
                <div class="card text-center">
                            ...
                            <p class="id-number">{{ Auth::user()->getAdviserAdmin->university_number }}</p>
                            <h4 class="student-name">{{ Auth::user()->getAdviserAdmin->firstname . ' ' . Auth::user()->getAdviserAdmin->lastname }}</h4>
                ...
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <h6 class="text-muted">{{ Auth::user()->getAdviserAdmin->firstname . ' ' . Auth::user()->getAdviserAdmin->middlename . ' ' . Auth::user()->getAdviserAdmin->lastname }}</h6>
                        </div>

                        <div class="col-sm-6">
                            <div class="data font-weight-bold">University Number</div>
                            <h6 class="text-muted">{{ Auth::user()->getAdviserAdmin->university_number }}</h6>
                        </div>
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            ...
                            <h6 class="text-muted">{{ Auth::user()->getAdviserAdmin->phone_number }}</h6>
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <h6 class="text-muted">{{ Auth::user()->getAdviserAdmin->home_address }}</h6>
                        </div>
